...
### 1b. [PERGUNTA DE ARQUIVO] A publicação especial sobre o desenho da amostra de 1,27% de 1960 e os erros de amostragem, prometida em 1965, não é localizável

**Arquivos.** *Censo Demográfico: resultados preliminares*, Série Especial, vol. II, IBGE / Serviço Nacional de Recenseamento, março de 1965 (Biblioteca do IBGE, `liv84480`, 41 p.).

**Evidência.** À p. 6, ao descrever o desenho da amostra de 1,27% — subamostra de uma pasta em vinte, sorteada sistematicamente dentro de estratos de geografia e situação, 814 pastas —, o volume afirma: "Os cálculos de erros de amostragem para as características apresentadas estão sendo executados. Deixamos de incluí-los nesta publicação, a fim de evitar seu retardamento. Entretanto, farão parte de uma publicação especial em que se fará descrição detalhada do desenho da amostra e das técnicas utilizadas." Procurada em 14/09/2026: no catálogo da Biblioteca do IBGE, a Série Especial do Censo Demográfico de 1960 tem apenas o vol. II (`liv84480`) e o vol. IV (favelas do Estado da Guanabara); no Internet Archive, coleção Memória Estatística do Brasil, os mesmos dois volumes (`censoesp1960vol2res`, `censoesp1960vol4fav`); e o volume nacional definitivo (Série Nacional, vol. I), que descreve o desenho da amostra de 25% e o estimador de razão com pesos inteiros, não a cita.

**Pedido.** Saber se essa publicação chegou a existir, e se há no arquivo do Instituto — ainda que como documento interno — a descrição dos estratos e das frações de sorteio da subamostra de 1,27%; e se os cartões perfurados ou as fitas originais dessa amostra foram preservados. Sem isso, os estratos têm de ser reconstruídos a partir do próprio arquivo: a numeração das pastas confirma o sorteio sistemático de uma em vinte por estratos de situação, e o corte de 100.000 habitantes foi aproximado pela população urbana municipal do Anuário Estatístico de 1961 — mas a definição exata dos estratos e a fração de sorteio de cada um só a publicação daria. Pergunta correlata: o *Código do Censo Demográfico – 1960*, manual de codificação do Serviço Nacional de Recenseamento, existe hoje apenas em cópia particular digitalizada, sem camada de texto e com linhas cortadas; há exemplar oficial digitalizado?
