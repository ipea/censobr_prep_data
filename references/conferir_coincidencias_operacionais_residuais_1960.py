"""Audita 32cartoes recuperados x reais/entre si e o distrito operacionalPE.
...
DEFAULT_INDEX="tmp/resolver_residuais_1960_20260922/cartoes_reauditoria_fechada/indice127.sqlite"
...
def audit(index,out):
    ...
    if len(manifest["cartoes"])!=32:raise ValueError("Escopo desta rodada deve ter32cartoes")
    ...
    result={"resumo":summary,"coincidencias_recuperado_real":matches,"coincidencias_entre_recuperados":between,
      ...
      "limites":["Nao executa R e nao declara que build completo chegaria a guarda: orfaos e outros bloqueios permanecem.",
        "Indice omite3registros corrompidos sem grupo e nao possui cartoes recuperados nem distritoPEderivado; estes32cartoes e2distritos sao acrescentados SOMENTE em memoria.",
        ...
        "A equivalencia verificada e da assinatura de coincidencia e do subconjunto32cartoes/PE; nao e equivalencia geral indice-pipeline.",
