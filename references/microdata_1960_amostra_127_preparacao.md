...
- **Município.** `code_muni_1960` é V116 levado à divisão territorial de 1960 (`read_guides/1960_municipios.csv`, gerado da DTB de 1960 e do Anuário Estatístico do Brasil de 1961, com nome, código de 2010, zona fisiográfica e população total, urbana e rural de cada um dos 2.769 municípios). É igual a V116 em 24 UFs. Na Guanabara, V116 é o distrito (5411 a 5581) e o município é um só, 541, o Rio de Janeiro; em Alagoas, V116 vem deslocado em 200 (Maceió é 2506 no arquivo e 2306 na divisão territorial, e os 14 municípios da amostra caem na faixa certa, com Maceió 100% urbana e os rurais do Anuário em pastas rurais); em Fernando de Noronha vem 2701, e o território tem um município só, 2401. `censobr_muni_corrigido` marca as três UFs. Dois domicílios tinham código sem par na divisão territorial: um de São Paulo com 7234 (código que não existe; as duas linhas do boletim o trazem, e as outras 222 famílias da mesma pasta são 6234, São Paulo) e um do Paraná com "724Z" (um caractere corrompido em três linhas seguidas; as outras 276 famílias da pasta são 7240). Como a pasta é sorteada dentro do município e não há outra leitura possível, `code_muni_1960` recebe o município da pasta, marcado. V116 fica como está. Só a Serra dos Aimorés continua sem `code_muni`: é a região em litígio entre Minas e Espírito Santo, que o censo codificou como uma unidade só (5001, também na amostra de 25%) e que a divisão territorial reparte em vários municípios hoje capixabas; a malha de 1960 do `geobr` a traz como um único polígono de código 99.
