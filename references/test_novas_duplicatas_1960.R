...
stopifnot(nrow(manifesto) == 6451L, !anyDuplicated(manifesto$linha),
          sum(manifesto$acao == "remover") == 2736L,
          sum(manifesto$acao == "manter") == 3715L,
...
message("Manifesto temporario: 6451 linhas; 2736 remover; 3715 manter; sobrepostas: ", length(comuns))
...
stopifnot(identical(amplo, antes_amplo), nrow(amplo$pessoas) == 6451L,
          nrow(amplo_ok$pessoas) == 3715L, identical(sort(amplo_ok$pessoas$linha), manter),
...
arquivos_saida <- file.path(saida, c("entrada_6451.parquet", "retidas_3715.parquet",
  "removidas_2736.parquet", "acoes_conferidas_6451.parquet"))
...
indice <- list(
  ...
  entrada = 6451L, retidas = 3715L, removidas = 2736L,
...
message("Conferencia aprovada: 6451 entradas, 3715 retidas, 2736 removidas; todas as acoes verificadas.")
