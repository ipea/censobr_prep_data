# Levantamento para a carta ao IBGE

**Data:** 2026-09-12
**Escopo:** defeitos nos dados dos Censos Demográficos distribuídos pelo IBGE,
levantados a partir do trabalho do `censobr_prep_data` e verificados contra a
distribuição vigente no FTP
**Status:** material bruto verificado — a carta ainda não foi escrita

---

## Como este material foi produzido

Oito levantamentos independentes, um por edição ou eixo, cada um com duas
perguntas: o defeito existe e com que evidência numérica, e o IBGE já sanou na
distribuição atual ou persiste. Todo item destinado à carta passou depois por
uma verificação adversarial, feita por outro analista, com a instrução de
tentar derrubá-lo — porque reportar defeito já corrigido, ou defeito que é
nosso, enfraquece o documento inteiro.

| | |
|---|---:|
| itens confirmados que **persistem** | 75 |
| itens **refutados ou reescritos** na verificação | 8 |
| itens que o **IBGE já sanou** | 7 |
| itens que **não são defeito do IBGE** | 4 |

Os números por edição estão nas seções abaixo. Cada item traz a evidência
medida e como o estado atual foi verificado.

---

## O que NÃO entra na carta

Esta seção existe para que o trabalho de verificação não se perca e para que
nenhum destes itens volte por engano.

### O IBGE já corrigiu (7)

**Pessoa02 de Goiás com nomes de variável sem o zero à esquerda (V01–V099)**

Log 1_Atualizacoes_20260615.txt, entrada datada '15/19/2025' (sic, leia-se 15/09/2025): 'Foi verificado que no arquivo "Pessoa02" de Goiás, as colunas referêntes às variáveis de V001 a V099 foram nomeadas omitindo um 0. As colunas forma renomeadas e os arquivos nos formatos CSV e XLS foram substituídos.' Verificação nos arquivos: cabeçalho do Pessoa02_GO.csv do lote atual lido por HTTP Range em 12/09/2026, e data/CRC32 do Pessoa02_GO.xls no diretório central remoto.

**Ausência de RESPONSAVEL01_ES.csv na pasta CSV do Espírito Santo, com um .xls ocupando o lugar**

Listagem do diretório central do ES_20260615.zip por HTTP Range e comparação com a listagem do ES_20231030.zip local, em 12/09/2026; download por Range dos dois membros (CSV 288.944 bytes comprimidos, XLS 894.210) e comparação célula a célula em R com readxl + data.table.

**Nome de arquivo com ponto duplicado: Pessoa02_ES..csv**

Comparação das listagens de membros entre ES_20231030.zip local e ES_20260615.zip remoto (diretório central por HTTP Range), 12/09/2026; varredura de nomes anômalos nas 28 publicações do lote atual.

**Cod_setor destruído por notação científica na primeira coluna de 79 arquivos CSV, em todas as 27 UFs**

Log 1_Atualizacoes_20260615.txt, entrada de 15/06/2026: 'Descrição: A variável Cod_setor (1ª coluna) dos arquivos em formato CSV estavam corrompidas. Ações: Os arquivos foram corrigidos e substituídos.' Verificação nos arquivos: varredura local dos 28 zips antigos guardados em data_raw/tracts/2010/; download integral do AC_20260615.zip (5,8 MB) e conferência dos 26 CSV; amostragem por HTTP Range das 28 publicações atuais. Tudo em 12/09/2026.

**CSV distribuídos com separador vírgula e aspas duplicadas em vez do padrão ponto-e-vírgula do lote**

Leitura do cabeçalho dos arquivos antigos nos zips locais e dos atuais por HTTP Range, 12/09/2026. A regeração de 15/06/2026 reescreveu todos os CSV e uniformizou o formato, embora o log só mencione a coluna Cod_setor.

**Perda de decimais nas colunas V003–V012 do Basico — NÃO é defeito do IBGE**

Download integral do AC_20260615.zip e comparação em R (readxl col_types='text' + data.table) de todas as 26 tabelas, XLS contra CSV, em 12/09/2026; leitura dos 28 Basico XLS para contagem de NA em V003 e V009. Registrado aqui para que a carta não impute ao IBGE um defeito que é de leitura no nosso lado.
...
**Divergência entre duas distribuições da mesma amostra: a versão CSV preparada perde 10 domicílios e 58 pessoas em Ariquemes/RO — o DBF do FTP é que está correto**

Comparando as duas fontes município a município, a única divergência material está em Ariquemes/RO (código 1100023, MUNICNUM 0002): o DBF tem 1.972 domicílios e 8.511 pessoas, a versão preparada tem 1.962 e 8.453. Há ainda 1 pessoa a mais no DBF num município da Bahia (MUNICNUM 0130). Quem está certo é o DBF: a soma dos pesos das 8.511 pessoas do DBF em Ariquemes dá 83.683,9989756, contra um universo publicado de 83.684 (FRACAMO.TXT, e a soma dos pesos dos domicílios dá 19.272,9998 contra 18.979); a versão preparada expande para apenas 83.098,89, ficando 585 pessoas abaixo da população do muni

**Perda de decimais nas colunas V003–V012 do Basico — NÃO é defeito do IBGE**

Comparação célula a célula entre o XLS (intocado desde 2012) e o CSV regerado em 15/06/2026, para as 26 tabelas do Acre: 874 linhas em ambos os formatos em todas as tabelas, mesmas colunas, 3.443.000+ células numéricas comparadas, 0 divergentes, 0 NAs assimétricos e 0 colunas presentes em um formato e ausentes no outro. No Basico do AC as 12 colunas V estão completas nos dois formatos com os decimais intactos ('3,39' no XLS, '"3,39"' no CSV). Os 1.800.306 valores decimais que viraram NA no v0.5.0 existem na fonte. Correlato: a issue #71 do censobr, que reportava a coluna V009 do Basico cheia d

**Domicilio01 do RS substituído pelo conteúdo de Pessoa11, e Responsavel01 do ES inteiramente NA — NÃO são defeitos do IBGE**

São consequências, no pipeline antigo, de duas irregularidades de formato do IBGE, e não erros de conteúdo da fonte. No RS, o Domicilio01_RS.xlsx não era encontrado por uma busca restrita a '.xls' e o lugar acabou preenchido com Pessoa11 (134 colunas coincidentes, 107 vazias, soma de 20.754.004 contra os 112.321.585 corretos). No ES, a ausência de Responsavel01_ES.csv deixou as 109 colunas 100% NA nos 6.380 setores. A validação contra a fonte fecha nos dois casos: as 241 somas de domicilio01 do RS batem com o DOMICILIO01_RS.csv do IBGE, e o Responsavel01_ES.csv novo bate com o XLS em 678.233 d

**A única versão pública da amostra de 1,27% de 1960 tem corrupção de gravação de origem, herdada de conversão de mídia**

174.467 registros de domicílio, dos quais 29 problemáticos (caracteres alfabéticos em campo numérico, espaços deslocando o registro, valores fora do dicionário). Exemplo literal de linha corrompida: '31   M       1BA33HIA' — a palavra BAHIA gravada dentro de campo numérico. Após consistência e imputação cruzada pessoa↔domicílio restam 299 registros inconsistentes: 3 em UF, 44 em V116 (município), 280 em V118 (rural/urbano).

### Refutados ou reescritos na verificação (8)

A verificação adversarial derrubou ou exigiu reescrita destes. O texto abaixo é
a instrução do verificador — seguir antes de aproveitar qualquer um.

**A pasta Divisão Territorial do Brasil traz só 2 das 5 regiões, e ainda assim numa divisão territorial posterior a 1980**

Manter o item, mas reescrever titulo e evidencia. O nucleo (incompletude) sobrevive; a acusacao de anacronismo tem de sair do lugar onde esta e ir para onde ela e verdadeira.

TITULO SUGERIDO: "A pasta 'Divisao Territorial do Brasil' cobre so 2 das 5 regioes, e as duas planilhas entregues nao fecham com os proprios microdados do pacote"

EVIDENCIA A USAR:
1. Zip unico Microdados_Censo_Demografico_1980_Amostra.zip, 544.850.882 bytes, Last-Modified 2025-01-09 22:08:20 GMT (HEAD em 2026-09-12), 79 entradas. A pasta "Divisao Territorial do Brasil/" tem exatamente 2 arquivos: "DTB - Regiao Centro-Oeste.xls" (168.960 B) e "DTB - Regiao Sul.xls" (430.592 B). Nao ha DTB de Norte, Nordeste ou Sudeste — 19 das 27 UFs ficam sem divisao territorial documentada. O Leiame.txt sequer menciona a pasta.
2. Antecipar a objecao: existe uma DTB nacional em "Arquivos Auxiliares/Divisao Territorial Brasileira.xls" (2.985.472 B), mas ela nao serve para 1980 — traz 5.507 municipios, 558 microrregioes e o Tocantins como UF 17, isto e, a DTB do Censo 2000. E coerente com o resto daquela pasta, que e o kit aux

**Código de "Ignorado" das variáveis de renda documentado como 0 — mas 0 é valor legítimo e o código real (todos noves) não está documentado: 2.161.770 registros**

NÃO usar o item como está — a frase "o código real (todos noves) não está documentado" é falsa e o IBGE derruba abrindo a própria planilha. Substituir por DOIS itens separados.

ITEM A (reescrito, menor, ainda válido)
Título: "Dicionário 1991.xls: a coluna 'Ignorado' da tabela de layout contradiz o bloco de categorias da mesma planilha em 25 variáveis, entre elas as nove de valor de rendimento"
Texto: No arquivo Documentação/Dicionário 1991.xls (aba 'Layout'), cada variável aparece duas vezes: uma linha na tabela-resumo (com as colunas Min Range, Max Range, NSA, Ignorado) e, logo abaixo, um bloco 'Categorías' com um código por linha. Para as nove variáveis de valor de rendimento os dois trechos discordam. O bloco Categorías traz corretamente 999999999 = Ignorado (RDOMICIV, RFAMILIV), 99999999 = Ignorado (RFACHCAV, RTOTALPV), 9999999 = Ignorado (RPRINCIV, ROUTOCUV, ROUTRENV, RAPOSENV) e 999999998 = Ignorado para RFAPCAPV em notação de dígitos crus (= 9.999.999,99). A coluna 'Ignorado' da tabela-resumo, porém, traz 0 nas nove. Como a tabela-resumo é a parte legível por máquina (uma lin

**A planilha auxiliar de areas de ponderacao traz a contagem populacional SUPERADA de 2000, incompativel com os pesos dos proprios microdados**

TIRAR O ITEM DA CARTA como esta. Ele afirma que a planilha traz cifra superada e que os pesos incorporam uma revisao — nada disso existe, e o IBGE responderia em uma linha apontando a t/202 do SIDRA e o paragrafo "Analise da qualidade da calibracao" da propria documentacao que acompanha o arquivo. Mandar isso enfraquece o resto da carta mais do que um item "ja sanado".

O QUE SOBRA E PODE SER REAPROVEITADO — e um pedido de transparencia, nao um defeito, e precisa de outro titulo e outro tom:

Titulo sugerido: "Nao ha, na documentacao dos microdados de 2000, a identificacao das areas de ponderacao em que a calibracao nao fechou o total de pessoas".

Redacao sugerida: a documentacao reconhece que a calibracao MQG pode nao ajustar a restricao 'numero total de pessoas' em algumas areas, e informa apenas que "mais de 91%" das 9.336 areas tiveram solucao com o conjunto 1 de restricoes. Nao se publica, porem, quais areas ficaram fora, nem qual conjunto de restricoes foi efetivamente usado em cada uma. Medindo diretamente os arquivos distribuidos, sao 265 areas (2,8%) em que a soma do peso P

**Código 02 da V4001 documentado no layout mas inexistente nos dados**

CORTAR o item da carta, ou rebaixá-lo a uma observação editorial de uma linha num bloco de 'sugestões de documentação', jamais como defeito de dado.

Se o mantenedor insistir em mantê-lo, a única redação defensável é:

'No layout dos microdados da amostra de 2010 (Layout_microdados_Amostra.xls, planilha DOMI, V4001, pos. 54-55) e na Descrição das variáveis, o código 02 (domicílio particular permanente ocupado sem entrevista realizada) é enumerado como valor possível da variável, embora — conforme o próprio texto da Descrição das variáveis e o tópico Tratamento dos domicílios fechados das Notas Metodológicas — esses domicílios tenham sido tratados por expansão dos pesos e não gerem registro na amostra. Verificamos que o código não ocorre em nenhum dos 6.192.332 registros de domicílio das 28 UFs. Sugerimos assinalar no layout, ao lado do código 02, a nota "não ocorre nos microdados da amostra; ver Tratamento dos domicílios fechados nas Notas Metodológicas".'

Se for para a carta, corrigir os números expandidos, que estão 1–2 unidades altos: usar 57.320.555 (01), 106.738 (05), 624.155 (

**Denominador não documentado do rendimento per capita (D0360 e F0260)**

NAO LEVAR ESTE ITEM PARA A CARTA COMO ESTA. "Denominador nao documentado de D0360 e F0260" e refutavel com um apontamento de pagina, e para F0260 e simplesmente falso -- o proprio Dicionario de Variaveis descreve a divisao e a exclusao. Um item assim entrega ao IBGE a chance de desqualificar a carta inteira ("o remetente nao leu a documentacao que acompanha a divulgacao").

Se o mantenedor quiser aproveitar o trabalho, ha duas reescritas possiveis, ambas bem menores:

1) INCONSISTENCIA ENTRE DICIONARIO E NOTA METODOLOGICA (editorial, MINOR).
   "No 'Dicionario de Variaveis - Microdados CD2022' (p.16), a entrada de D0360 (Rendimento domiciliar per capita) reproduz palavra por palavra a entrada de D0350 (Rendimento domiciliar): descreve 'a soma dos rendimentos mensais de todos os moradores do domicilio, excluindo-se os rendimentos de pensionistas, empregados domesticos e parentes de empregados domesticos', sem mencionar a divisao nem o denominador. As duas variaveis ficam definidas com o mesmo texto. A definicao correta e completa -- 'a divisao ... pelo numero de moradores do domicilio

**871 setores têm entorno de faces mas não têm entorno de domicílios nem de moradores**

Não mandar o item como está. Reescrever em três movimentos, mantendo os números (que são todos corretos) e trocando a tese.

1) TÍTULO E TESE. Trocar "871 setores têm entorno de faces mas não têm entorno de domicílios nem de moradores" por algo como: "Ausência de linhas de valor zero e de indicador de cobertura nos agregados de entorno por setor de 2022". A reclamação defensável não é perda de registro — é que o usuário não consegue distinguir "setor fora do universo do entorno", "setor no universo com zero domicílios vinculados a faces levantadas" e "setor com registro faltando", porque os três casos se apresentam do mesmo jeito: linha ausente. Consequência concreta e verificável: um join entre os três arquivos de entorno descarta 3.876 setores em silêncio, 871 deles com domicílios particulares ocupados (69.759 DPO, 197.505 moradores).

2) O QUE APRESENTAR COMO EVIDÊNCIA (tudo remedido e confirmado):
   - 344.841 / 340.965 / 340.965 setores; domicílios ≡ moradores; ambos contidos em faces; 3.876 exclusivos; 3.005 com V0007 = 0 e 871 com V0007 > 0.
   - Entre os 340.965 publicados, Z

**A amostra de 25% de 1960 nunca foi integralmente processada: o IBGE só tem 14 UFs, e com circulação restrita**

REESCREVER O ITEM ASSIM (todos os numeros abaixo foram medidos por mim):

TITULO: "A amostra longa (25%) de 1960 nunca foi integralmente processada — faltam 11 unidades da federacao, ~18% da populacao — e o IBGE nao distribui microdado algum de 1960."

TEXTO:
1. O FTP do IBGE (https://ftp.ibge.gov.br/Censos/, consultado em 12/09/2026) comeca em 1970. O caminho /Censos/Censo_Demografico_1960/ retorna HTTP 404. Nao ha 1940, 1950 nem 1960. Nao existe, portanto, nem arquivo nem log de atualizacao para a edicao de 1960 — a primeira com processamento automatizado e digitalizacao das respostas.

2. Segundo o dicionario da propria fita magnetica do IBGE, a amostra de 25% de 1960 cobre 17 unidades: "RN, AL, BA, CE, PB, PE, SE, FN, GO, MT, DF, SA, MG, RJ, PR, SP E RS" (14 estados + Fernando de Noronha + Distrito Federal + Serra dos Aimores).

3. Ficaram de fora 11 unidades: Rondonia, Acre, Amazonas, Roraima, Para, Amapa, Maranhao, Piaui, Espirito Santo, Guanabara e Santa Catarina. (NAO escrever "a antiga Regiao Norte, SC e ES" — omite MA, PI e Guanabara.) Essa lista e confirmada de forma indep

**Microdados 2022 — pares .ods/.xlsx do mesmo documento com vintages muito distantes e sem indicação de qual é o corrente**

Não mandar o item como está: a frase "55 códigos íntegros num formato e não no outro" é falsa e derruba o item inteiro em um minuto de conferência do IBGE. Partir em dois.

ITEM A (documentação/procedimento — manter, reescrito):
"Em /Censos/Censo_Demografico_2022/Microdados_e_Areas_de_Ponderacao/Documentacao/, nas subpastas 'Bancos de descritores/' e 'Áreas de ponderação/', cada documento é distribuído em .ods e .xlsx, e o índice do FTP mostra datas muito distantes entre os dois formatos do MESMO documento — 'Codificação_Atividade CD2022' tem .ods de 17/08/2026 21:05 e .xlsx de 16/10/2025 16:12; 'Áreas de Ponderação por UF e Município', .ods de 17/08/2026 21:01 e .xlsx de 28/05/2026 15:58; e assim em pelo menos seis pares. Verificamos célula a célula que o conteúdo dos dois formatos é idêntico — os .ods são exportações em lote feitas do próprio Excel em 17–19/08/2026, e a data antiga do .xlsx é a da última edição da planilha. Ainda assim, nada na pasta e nada no Leia-me.pdf (19/08/2026) informa isso. O usuário que compara as datas conclui, razoavelmente, que um dos formatos está desa
...
**Evidência.** https://ftp.ibge.gov.br/Censos/Censo_Demografico_1960/ responde HTTP/1.1 404 Not Found (Apache/2.4.37, 12/09/2026 19:42 GMT); idem 1950/ e 1940/. Varredura recursiva de toda a árvore /Censos/ (47.748 entradas, ~1.000 índices) não devolve nenhum arquivo de 1960. Pastas adjacentes checadas e descartadas: /seculoxx/ (leia_me.txt: 'tabelas encontradas no CD-ROM Estatísticas do Século XX... conjunto de tabelas em Excel' — agregados, não microdados), /Informacoes_Gerais_e_Referencia/, /Documentos/, /Estoque/. O que o IBGE de fato publica de 1960 são os volumes impressos digitalizados na Biblioteca (ex.: https://biblioteca.ibge.gov.br/visualizacao/periodicos/68/cd_1960_v1_t9_mg.pdf → HTTP 200, application/pdf): tabulações, não registros. Consequência medida no produto do censobr: como o IBGE não distribui registro nenhum de 1960, o insumo teve de ser reconstruído a partir de dois arquivos preservados fora do Instituto — a amostra de 25%, que é a amostra geral do censo (Boletim de Amostra CD 2, um domicílio em cada quatro), sobrevivente para 17 unidades da federação, e a subamostra de 1,27% sorteada em 1965, sobrevivente para as 28. Em 1960_population_v1.0.0.parquet, 15.145.810 pessoas: censobr_amostra == '25%' = 14.983.769 registros cobrindo 17 códigos de UF e censobr_amostra == '1,27%' = 162.041 cobrindo os 11 restantes; os dois conjuntos são disjuntos por UF, e a soma de pesos é 70.191.146 contra os 70.191.370 presentes que a Série Nacional publica (−0,0003%). Duas observações de procedência, ambas medidas nesta reconstrução e que corrigem o que se supunha antes: o arquivo de 25% não é uma extração de 5% do IPUMS, e sim a própria amostra geral do censo — a de 1,27% foi encontrada inteira dentro dele, casando pela chave do questionário em 143.077 dos 143.223 domicílios (99,90%); e o arquivo bruto está estruturalmente íntegro (18.055.053 linhas, todas com 54 caracteres, nenhum caractere fora de [0-9 ] em 948 MB), o que mostra que o que falta é distribuição, não preservação.
...
**Estado hoje: não localizada.** Sem ela, os estratos do sorteio têm de ser reconstruídos a partir do próprio arquivo — região cruzada com os quatro grupos de situação de 1965, 16 estratos e 817 unidades primárias. A numeração das pastas confirma o sorteio sistemático de uma em vinte por estratos de situação; o quarto grupo, cidades de 100.000 habitantes e mais, foi aproximado pela população urbana municipal do Anuário Estatístico de 1961 (34 municípios), porque o volume não diz como o corte foi operacionalizado. Correlato: o *Código do Censo Demográfico – 1960* (manual de codificação do órgão central, 25 p.) só existe em cópia particular digitalizada, sem camada de texto e com linhas cortadas; vale perguntar por um exemplar oficial.
...
**Estado hoje: persiste.** crawler próprio do índice HTML do FTP (1970, 1980, 1991, 2000, 2010, 2022), 12/09/2026; grep -i 'atualiza|leia.?me|errata|retific|corrig|changelog|historico' sobre o índice consolidado

#### [ALTA] O pacote de microdados de 1980 traz, como 'Arquivos Auxiliares', a documentação do Censo de 2000

**Arquivos.** https://ftp.ibge.gov.br/Censos/Censo_Demografico_1980/Microdados/Microdados_Censo_Demografico_1980_Amostra.zip — 544.850.882 bytes, Last-Modified Thu, 09 Jan 2025 22:08:20 GMT, ETag "2079c3c2-62b4d375174bf", 79 entradas. Pasta afetada: Arquivos Auxiliares/ (20 arquivos)

**Evidência.** Prova literal: o membro 'Arquivos Auxiliares/V1004.txt' (841 bytes) começa com as linhas 'CENSO DEMOGRÁFICO- 2000 / MICRODADOS DO UNIVERSO / V1004 - REGIÃO METROPOLITANA'. O membro 'Arquivos Auxiliares/Composicao_das_Areas_de_Ponderacao.txt' (6.690.206 bytes) é uma tabela 'Código do Setor Censitário' → 'Código da área de ponderação' com códigos de setor de 15 dígitos (110001505000001 → 1100015001001): setor censitário e área de ponderação são conceitos de 2000/2010, inexistentes em 1980. Os nomes de variável do restante da pasta são todos do Censo 2000 e nenhum existe no layout de 1980: V4090 (religião), V4210/V4230/V4260 (migração), V4219/V4239/V4269/V4279 (ONU), V4250 (municípios), V4276 (municípios e país estrangeiro), V4534/V4535 (cursos superiores). O conjunto é o mesmo de https://ftp.ibge.gov.br/Censos/Censo_Demografico_2000/Microdados/1_Documentacao_20170908.zip (2.961.444 bytes, 08/09/2017), pasta 'Arquivos Auxiliares/': 'Composicao das Areas de Ponderaçao.txt' = 6.690.211 bytes lá contra 6.690.206 aqui; 'Lista das Areas de Ponderacao-Brasil.xls' = 1.114.624 bytes nos DOIS pacotes, tamanho idêntico. O Leiame.txt do próprio zip de 1980 (473 bytes) só reconhece como documentação 'o arquivo Documentação.xls na pasta Layout' — não menciona os Arquivos Auxiliares.

**Estado hoje: persiste.** leitura do central directory do zip remoto por HTTP Range (sem baixar os 545 MB) e inflate parcial dos membros V1004.txt, Composicao_das_Areas_de_Ponderacao.txt e Leiame.txt, em 12/09/2026; mesmo método aplicado ao 1_Documentacao_20170908.zip de 2000 para o cotejo

#### [ALTA] Censo 2000 — RN.zip embute a Paraíba inteira e BA.zip traz zips aninhados; nada disso consta do log

**Arquivos.** https://ftp.ibge.gov.br/Censos/Censo_Demografico_2000/Microdados/RN.zip — 36.516.253 bytes, Last-Modified Fri, 08 Sep 2017 18:44:15 GMT, 7 entradas. https://ftp.ibge.gov.br/Censos/Censo_Demografico_2000/Microdados/PB.zip — 20.277.900 bytes, 08/09/2017, 4 entradas. https://ftp.ibge.gov.br/Censos/Censo_Demografico_2000/Microdados/BA.zip — 71.183.399 bytes, 08/09/2017, 4 entradas

**Evidência.** RN.zip contém RN/DOM24.txt, RN/FAMI24.TXT, RN/PES24.txt (Rio Grande do Norte, código 24) E TAMBÉM RN/DOM25.txt, RN/FAMI25.TXT, RN/PES25.txt (Paraíba, código 25). Os três da PB são byte a byte iguais aos de PB.zip: CRC32 2313D407 (DOM25, 20.223.244 bytes), DA05E397 (FAMI25, 15.406.918) e 15F63ADF (PES25, 185.047.488), idênticos nos dois pacotes; confirmado por MD5 nas cópias locais — PB/PES25.txt e RN/PES25.txt = edca508089c47d5f83549af235bd6151, PB/DOM25.txt e RN/DOM25.txt = 8c31f60b08186d5af3693eea371945d2. São 487.848 pessoas, 117.577 domicílios e 128.390 famílias da Paraíba duplicadas: quem baixar as 27 UFs e fizer um glob ingênuo conta a Paraíba duas vezes, em silêncio, e nenhuma verificação de UF pega o erro porque os registros trazem o código 25 corretamente. BA.zip, por sua vez, traz BA/DOM29.txt em texto puro mas BA/FAMI29.zip (8.523.463 bytes) e BA/PES29.zip (54.279.937 bytes) — zips dentro do zip: quem não fizer uma segunda passada de descompactação perde as pessoas e as famílias da Bahia inteira. O log 2_Atualizacoes_20170908.txt, de 482 bytes, registra apenas três eventos (19/06/2015 registros corrompidos, 09/03/2016 atividade/ocupação e V0300, 08/09/2017 V0300) e não menciona nenhum dos dois casos.

**Estado hoje: persiste.** central directory dos três zips remotos lido por HTTP Range em 12/09/2026 (CRC32 e tamanhos descomprimidos); md5sum das cópias já extraídas em data_raw/microdata/2000/txt/; wc -l para as contagens de registro

#### [ALTA] Setores 2010 — o shift de +85 nos nomes de coluna do Pessoa02 de São Paulo sobreviveu à republicação de 15/06/2026

**Arquivos.** SP_Capital_20260615.zip (167 MB, Last-Modified 15/06/2026) → 'Base informaçoes setores2010 universo SP_Capital/CSV/pessoa02_sp1.csv'; SP_Exceto_Capital_20260615.zip (461.345.153 bytes, 15/06/2026) → '.../CSV/pessoa02_sp2.csv' (34.473.156 bytes, CRC 5F83489E)

**Evidência.** Cabeçalho de pessoa02_sp1.csv e de pessoa02_sp2.csv: 'Cod_setor';'Situacao_setor';'V086';'V087';…;'V255' — 172 colunas, 170 delas V, começando em V086 e terminando em V255. Nas demais UFs o mesmo arquivo traz V001…V170: verificado em Pessoa02_RR.csv (172 colunas, V001…V170), Pessoa02_GO.csv (172 colunas, V001…V170) e Pessoa02_CE.csv (172 colunas, V001…V170). O deslocamento é exatamente +85, que é o número de colunas V do Pessoa01 (pessoa01_sp2.csv: 87 colunas, V001…V085) — ou seja, o SP foi numerado como se o Pessoa02 continuasse a contagem do Pessoa01. Consequência para o usuário: ao empilhar as 27 UFs por nome de coluna, São Paulo não casa com ninguém — as 85 primeiras variáveis de SP ficam vazias e as 85 últimas recebem valores de outra variável.

**Estado hoje: persiste.** leitura do cabeçalho dos membros CSV dentro dos zips remotos de 15/06/2026, por HTTP Range + inflate parcial, em 12/09/2026; comparação com RR (zip baixado integralmente, MD5 4660744e2831de14f4127eeac753e0c2) e com GO/CE pelo mesmo método

#### [ALTA] Agregados por setor 2022 — o pacote 'xlsx' de características do domicílio 2 e 3 contém um CSV, e a versão .xlsx corrigida não existe
...
**Estado hoje: persiste.** central directory dos zips remotos lido por HTTP Range (nome, tamanho descomprimido e CRC32 de cada membro), em 12/09/2026; HEAD para Last-Modified e Content-Length

#### [MEDIA] Divisão Territorial do Brasil incompleta nos pacotes de microdados de 1970 e 1980
...
**Estado hoje: persiste.** central directory dos zips remotos via HTTP Range, 12/09/2026

#### [MEDIA] Setores 2010 — bloco descritivo de 19 colunas continua ausente no Entorno de CE, DF, MG, PE e RS

**Arquivos.** Entorno01…Entorno05 de CE_20260615.zip, DF_20260615.zip, MG_20260615.zip, PE_20260615.zip e RS_20260615.zip (todos Last-Modified 15/06/2026)

**Evidência.** Entorno01 tem 203 colunas nessas cinco UFs (Cod_setor; Situacao_setor; V001…V201) contra 222 em AC, RR, GO e SP (Cod_setor; Setor_Precoleta; Cod_Grandes Regiões; Nome_Grande_Regiao; Cod_UF; Nome_da_UF; Cod_meso; Nome_da_meso; Cod_micro; Nome_da_micro; Cod_RM; Nome_da_RM; Cod_municipio; Nome_do_municipio; Cod_distrito; Nome_do_distrito; Cod_subdistrito; Nome_do_subdistrito; Cod_bairro; Nome_do_bairro; Situacao_setor + V001…V201). Entorno05: 222 colunas nas cinco contra 241 nas demais. Além da ausência, a segunda coluna tem NOME DIFERENTE entre as duas famílias — 'Situacao_setor' nas cinco UFs e 'Setor_Precoleta' nas outras 22 — o que faz um empilhamento por posição juntar variáveis distintas em silêncio.

**Estado hoje: persiste.** cabeçalhos de Entorno01 e Entorno05 lidos dentro dos zips remotos de 15/06/2026 via HTTP Range, para CE, DF, MG, PE, RS, AC e RR, em 12/09/2026

#### [MEDIA] Setores 2010 — Domicilio01 do RS continua sendo o único Excel do lote em .xlsx, e a documentação não acompanhou a republicação

**Arquivos.** RS_20260615.zip (137.504.353 bytes, Last-Modified Mon, 15 Jun 2026 11:37:18 GMT): a pasta EXCEL/ tem 'Domicilio01_RS.xlsx' (21.367.859 bytes, CRC 19AF9AC8, data interna 2024-12-11) e NÃO tem 'Domicilio01_RS.XLS'. Documentacao_Agregado_dos_Setores_2010_20231030.zip (33 MB) segue com data 30/10/2023

**Evidência.** Nos outros 26 pacotes o Domicilio01 vem em .XLS de 2012 (ex.: ES_20260615.zip traz 'EXCEL/Domicilio01_ES.XLS', 9.883.136 bytes, data interna 2012-05-17). No RS o arquivo é .xlsx, foi anexado ao fim do zip (aparece depois dos demais no central directory) e conserva a data de 11/12/2024. Um discovery de arquivos que procure '.xls' — que é o formato de 26 dos 27 pacotes — não encontra o Domicilio01 do RS, e a tabela some ou é preenchida por outra. Segundo ponto: todos os 27 zips de dado foram reemitidos em 15/06/2026, mas o pacote de documentação continua na versão de 30/10/2023, anterior às correções de GO (09/2025) e do próprio Cod_setor (06/2026).

**Estado hoje: persiste.** central directory de RS_20260615.zip e ES_20260615.zip lido por HTTP Range em 12/09/2026; listagem datada do diretório Agregados_por_Setores_Censitarios

#### [MEDIA] Microdados 2022 — o banco de descritores de Atividade grava como número os 55 códigos que começam com zero
...
**Estado hoje: persiste.** download dos dez arquivos (.ods e .xlsx) dos cinco bancos de descritores em 12/09/2026 e comparação célula a célula via leitura direta de content.xml (ODS) e sharedStrings.xml + sheet1.xml (XLSX); inspeção de xl/styles.xml para confirmar a máscara 00000

#### [BAIXA] O log de atualização dos setores de 2010 registra uma data impossível: 15/19/2025
...
**Estado hoje: persiste.** download e leitura integral do log em 12/09/2026; cotejo com o nome do zip GO_20250915.zip preservado em data_raw/tracts/2010/ e com a listagem histórica do diretório

#### [BAIXA] Microdados 2010 — o pacote de documentação inclui um arquivo de lock do LibreOffice

**Arquivos.** https://ftp.ibge.gov.br/Censos/Censo_Demografico_2010/Resultados_Gerais_da_Amostra/Microdados/Documentacao.zip — 10.711.779 bytes, Last-Modified Tue, 13 Mar 2018 18:19:17 GMT, 53 entradas. Membro: 'Documentação/Áreas de Ponderação/.~lock.Composição das Áreas de Ponderação.ods#', 108 bytes, CRC 93984D1B, data interna 2013-11-06

**Evidência.** É um arquivo temporário de sessão do LibreOffice, que registra usuário e máquina de quem tinha a planilha aberta, empacotado e publicado junto do produto oficial e mantido no ar há mais de doze anos. Sem efeito sobre os dados, mas indica que o pacote foi montado a partir de uma pasta de trabalho, sem passo de limpeza.

**Estado hoje: persiste.** central directory de Documentacao.zip lido por HTTP Range em 12/09/2026

#### [BAIXA] Pacote de 1970 — pasta com erro de grafia e 27 arquivos de dado com três convenções de maiúsculas
...
**Estado hoje: persiste.** central directory do zip remoto lido por HTTP Range em 12/09/2026

### 1970 — 3 itens (2 de gravidade alta)

#### [ALTA] 1.785 registros deslocados em DAMO70AL.txt e Damo70PE.txt (violam o LRECL de 76 bytes da própria documentação do IBGE)
...
(a) O documento fixa a especificação oficial: 'TAMANHO DO REGISTRO (LRECL): 76 bytes'. Logo, as 1.785 linhas anômalas violam o layout publicado pelo próprio IBGE -- não é interpretação nossa.
...
**Estado hoje: persiste.** HEAD em https://ftp.ibge.gov.br/Censos/Censo_Demografico_1980/Microdados/Microdados_Censo_Demografico_1980_Amostra.zip em 12/09/2026: Last-Modified Thu, 09 Jan 2025 22:08:20 GMT, Content-Length 544.850.882, ETag "2079c3c2-62b4d375174bf" -- idênticos ao arquivo local baixado em 05/05/2026. Índice do diretório mostra 2025-01-09 19:08, 520M. Nenhum arquivo de log de atualização existe na pasta de 1980. Parse direto do cabeçalho dos 26 DBF extraídos do zip.

#### [ALTA] COMODOS (quesito 12, total de cômodos) corrompida em 47 dos 223 municípios de Goiás: médias de 43 cômodos por domicílio, 1.064 casos de dormitórios > cômodos totais, e 5.093 campos numéricos em branco
...
#### [ALTA] O Território de Fernando de Noronha (UF 20) está inteiramente ausente do DBF, e por isso os totais nacionais calculados a partir dele não fecham com o que o próprio IBGE publicou
...
**Estado hoje: persiste.** Listagem completa do zip (79 arquivos) obtida com unzip -Z1 e conferida contra o FTP em 12/09/2026; só existem 26 UFs. A paridade com o SIDRA foi estabelecida em apuração anterior deste projeto (references/microdata_1980_pesos_v603_v604.md, 40 células para domicílios e 20 para pessoas) e reconferida aqui somando os 26 DBF.

#### [MEDIA] 54 domicílios particulares permanentes (ESPECIE=1) com peso zero (PESOD=0), dentro do universo ponderado
...
**Estado hoje: persiste.** Mesmo arquivo verificado no FTP em 12/09/2026 (inalterado desde 09/01/2025). Contagem direta nos 26 DBF de domicílio. Na amostra preparada anterior os mesmos registros aparecem com peso zero (55 lá, porque inclui um de Fernando de Noronha que o DBF não traz), e o mesmo valor está em v0.2.0, v0.3.0 e v0.5.0 do censobr -- três distribuições sem tratamento.

#### [MEDIA] 169.987 registros de domicílio coletivo (45,2% de todos os coletivos) não têm nenhum morador no arquivo de pessoas, nenhum peso e nenhum dado substantivo
...
**Estado hoje: persiste.** Cruzamento feito nas 26 UFs a partir dos DBF extraídos do zip do FTP (inalterado desde 09/01/2025). Contador V601 lido do parquet release_legacy. O Leiame.txt do pacote diz apenas que os dois arquivos se ligam por UF, MUNIC, CONTADOM, sem uma palavra sobre coletivos sem morador.

#### [MEDIA] A pasta Arquivos Auxiliares do pacote de 1980 contém documentação dos Censos de 1991 e 2000, não de 1980
...
**Estado hoje: persiste.** Arquivos extraídos do zip baixado do FTP (inalterado desde 09/01/2025, conferido por HEAD em 12/09/2026) e abertos um a um com readxl/readLines.

#### [MEDIA] Na Documentação.xls a coluna Faixa foi destruída por conversão automática do Excel em 44 das 83 variáveis: os intervalos viraram datas
...
**Estado hoje: persiste.** Leitura direta de Layout/Documentação.xls, tanto o extraído do zip do FTP quanto a cópia local em data_raw/microdata/1980/layout (mesmos 203.776 bytes, 09/01/2025). Confirmado que a corrupção está no XLS do IBGE e não num passo de conversão nosso.

#### [MEDIA] A Documentação.xls omite 4 variáveis que estão no dado, duplica 2 linhas e nomeia errado a chave de ligação do arquivo de pessoas
...
**Estado hoje: persiste.** Comparação campo a campo entre os nomes do cabeçalho dos DBF (26 no de domicílio, 61 no de pessoa, layout idêntico nas 26 UFs) e as linhas de variável das duas folhas do XLS, lido com readxl. Leiame.txt extraído do zip do FTP.

#### [BAIXA] Sentinelas não declaradas e faixas declaradas que não correspondem ao dado
...
**Estado hoje: persiste.** Tabulação exaustiva de todos os valores de todos os campos de até 3 posições nos 26 DBF de domicílio e nos 26 de pessoa (1.961 pares campo/valor), confrontada com as categorias declaradas extraídas do XLS e com o questionário CD 1.01 do próprio pacote. Arquivo do FTP inalterado desde 09/01/2025.

### 1991 — 11 itens (3 de gravidade alta)

#### [ALTA] Dicionário rotula o código 16 de MIUFPAIS como "SE" (Sergipe); o código é a Bahia — 492.708 registros mal decodificados
...
**Estado hoje: persiste.** Soma de PESO por município em varredura completa dos 27 DBFs do zip atual do FTP; FRACAMO.TXT extraído do mesmo zip; tabelas de população baixadas do FTP em 2026-09-12 (Goias.zip 10.158 bytes, Last-Modified 2016-08-17 14:07:43 GMT; Parana.zip do mesmo diretório). Planilha completa dos 4.491 municípios em munic_peso_desvio.csv no scratchpad.

#### [MEDIA] LEIA_ME.DOC: seis linhas erradas na tabela de conferência e os 27 tamanhos em bytes descrevem um formato que não é o distribuído
...
**Estado hoje: persiste.** Texto do LEIA_ME.DOC extraído do zip atual; contagens reais obtidas dos cabeçalhos DBF (registros) e de cumsum(PESSOAN == 1) (domicílios) nos 27 arquivos; tamanhos reais do índice do zip e de stat. Zip reverificado por HEAD em 2026-09-12, inalterado desde 2025-01-09.

#### [MEDIA] O DBF não traz nenhum identificador de domicílio (V0102), e com ele perde-se a unidade submunicipal de amostragem
...
**Estado hoje: persiste.** Leitura dos 27 cabeçalhos DBF e comparação campo a campo (nome, tipo, tamanho, decimais): 0 UFs com layout divergente. Agrupamento e constância das variáveis de domicílio verificados por varredura completa. Zip do FTP reverificado em 2026-09-12.

#### [MEDIA] Dez domicílios com registros de pessoa ausentes: a numeração de morador pula, sem que os registros correspondentes existam
...
**Estado hoje: persiste.** Leitura completa do campo PESSOAN (bytes 419-420) nos 27 DBFs do zip atual do FTP, agrupamento por cumsum(PESSOAN == 1) e comparação de max(PESSOAN) com o tamanho do grupo. Contexto de cada anomalia impresso com município, CD107, PARENDOM, idade, sexo, cômodos e peso. Cruzamento com o parquet 1991_population produzido pelo nosso pipeline.

#### [BAIXA] Byte corrompido: um parêntese dentro do campo de renda domiciliar em um registro do Maranhão
...
**Estado hoje: persiste.** Varredura byte a byte das posições de campos numéricos nos 27 DBFs (conjunto permitido: 0x20, 0x2E, 0x30-0x39); localização confirmada por grep binário (grep -abo) e dump do registro com dd/od. Zip do FTP reverificado por HEAD em 2026-09-12.

#### [BAIXA] DEMOCOMO e DEMODORM: o código de não aplicável usado no dado (99,98) não é o declarado (9999) e é indistinguível de um valor legítimo
...
**Estado hoje: persiste.** Tabulação de todos os valores distintos dos dois campos nos 27 DBFs (209 e 119 valores distintos respectivamente); contagem cruzada com ESPECIE e com os campos em branco. Zip do FTP reverificado em 2026-09-12.

#### [BAIXA] MIUFPAIS: código 48 presente no dado sem entrada no dicionário; a lista pula os códigos 28, 48 e 57 e declara um código 100 que nunca ocorre
...
**Estado hoje: persiste.** Lista de categorias parseada da aba Layout do dicionário do zip atual; tabulação completa do campo nos 17.045.712 registros.

#### [BAIXA] Empacotamento: nomes internos do zip em CP850 sem marca UTF-8, byte de EOF do DOS solto no FRACAMO.TXT e arquivos sem quebra de linha final
...
**Estado hoje: persiste.** zipinfo -v e unzip -l sobre a cópia local (idêntica à do FTP por tamanho e ETag); od -c no final do FRACAMO.TXT e dos dois TXT; listagem HTML dos diretórios Indice_de_Gini e Sexo_Populacao_Residente do FTP em 2026-09-12.

#### [BAIXA] IDADEANO em branco em 41 registros — terceiro estado não previsto pelo dicionário, que declara NSA e Ignorado iguais a 0 (idade válida)
...
**Estado hoje: persiste.** Varredura completa do campo nos 17.045.712 registros (tabulação de valores e contagem de campos integralmente em branco), cruzada com as colunas Min/Max/NSA/Ignorado do dicionário.

### 2000 — 8 itens (2 de gravidade alta)

#### [ALTA] RN.zip contem uma copia integral e byte-identica da Paraiba, sem qualquer aviso
...
**Estado hoje: persiste.** curl -sI em BA.zip em 12/09/2026: Content-Length 71183399, Last-Modified Fri, 08 Sep 2017 18:43:36 GMT — igual a copia local. unzip -l BA.zip e unzip -l nos dois zips internos no mesmo dia. O log de atualizacoes nao cita o assunto.

#### [MEDIA] Os nomes dos arquivos nao seguem o padrao das macros SAS que o proprio IBGE distribui, e variam de UF para UF
...
**Estado hoje: persiste.** unzip -l nos 27 zips e tabulacao dos radicais com sed/uniq -c em 12/09/2026; grep FILENAME nos tres .sas extraidos do zip de documentacao (Content-Length 2961444, Last-Modified 08/09/2017 18:43:23 GMT, confirmados por HEAD hoje).

#### [BAIXA] Byte de fim de arquivo do DOS (0x1A) cria registro-fantasma em dois arquivos de Minas Gerais
...
**Estado hoje: persiste.** tail -c 4 + xxd nos 81 arquivos extraidos dos zips baixados em 11/09/2026; HEAD do MG.zip no FTP em 12/09/2026 confirma Content-Length 104522854 e Last-Modified Fri, 08 Sep 2017 18:43:54 GMT, iguais a copia local.

#### [BAIXA] Um registro de domicilio de Pernambuco tem 167 bytes em vez dos 170 declarados no layout
...
**Estado hoje: persiste.** awk medindo length() em todos os 81 arquivos; inspecao campo a campo da linha 134.697 contra as linhas vizinhas; comparacao com "SAS/LE DOMIC.sas" extraido de 1_Documentacao_20170908.zip. HEAD do PE.zip em 12/09/2026: Content-Length 39193536, Last-Modified Fri, 08 Sep 2017 18:44:08 GMT.

#### [BAIXA] Todos os arquivos de familias (e o de pessoas de SP) terminam sem quebra de linha final
...
**Estado hoje: persiste.** tail -c 4 + xxd nos 81 arquivos; datas internas por unzip -l nos 27 zips; HEAD do SP.zip em 12/09/2026: Content-Length 194504171, Last-Modified Fri, 08 Sep 2017 18:44:46 GMT, igual a copia local.

#### [BAIXA] A planilha auxiliar conta um domicilio particular a mais do que a amostra entrega, em uma area de ponderacao do Recife
...
**Estado hoje: persiste.** leitura da planilha com readxl e cruzamento por codigo de area de ponderacao em R/data.table contra contagem por awk sobre os 27 DOM, em 12/09/2026; zip de documentacao e PE.zip conferidos por HEAD no mesmo dia, ambos com Last-Modified de 08/09/2017.

#### [BAIXA] O proprio log de atualizacoes esta com texto repetido e frase corrompida
...
**Estado hoje: persiste.** curl do arquivo e leitura em CP1252 em 12/09/2026; HEAD confirma Content-Length 482 e Last-Modified Fri, 08 Sep 2017 18:43:23 GMT.

### 2010 — agregados por setor — 6 itens (1 de gravidade alta)

#### [ALTA] Pessoa02 de SP_Capital e SP_Exceto_Capital com a numeração das 170 variáveis deslocada em +85, contrariando o dicionário oficial do próprio IBGE
...
**Estado hoje: persiste.** Diretório central do RS_20260615.zip lido por HTTP Range em 12/09/2026, com listagem completa dos 55 membros. Contagem de extensões feita sobre os diretórios centrais das 28 publicações do lote atual.

#### [MEDIA] Entorno de CE, DF, MG, PE e RS sem as 19 colunas descritivas de geografia que as outras 23 publicações trazem
...
**Estado hoje: persiste.** Cabeçalho do Entorno01 de cada uma das 28 publicações do lote 20260615, obtido por HTTP Range sobre o membro CSV dentro do zip remoto, em 12/09/2026. Comparação direta da lista de colunas não-V entre AC (222) e CE (203).

#### [MEDIA] Basico: as 10 colunas decimais V003–V012 são gravadas como texto em 24 publicações e como número em MG, PR, RJ e SP_Exceto_Capital
...
**Estado hoje: persiste.** Contagem sobre os diretórios centrais dos 28 zips do lote 20260615, lidos por HTTP Range em 12/09/2026.

#### [BAIXA] A documentação não foi atualizada em nenhuma das três correções: continua a de 30/10/2023, com conteúdo de 2011-2012
...
**Estado hoje: persiste.** Índice do FTP lido em 12/09/2026 (datas e tamanhos da listagem Apache); extração do PDF do zip local de documentação e conversão para texto com pdftools (201 páginas), com busca dos rótulos da seção 6.7; leitura integral de 1_Atualizacoes_20260615.txt (2.598 bytes).

### 2010 — microdados — 11 itens (0 de gravidade alta)

#### [MEDIA] Idades demograficamente impossíveis (115 a 139 anos) no registro de pessoas, sem crítica nem imputação
...
**Estado hoje: persiste.** O Documentacao.zip no FTP tem hoje Content-Length 10.711.779, exatamente o tamanho da cópia que abri; Last-Modified 13/03/2018 — nenhuma revisão posterior. Nenhum log registra correção de documentação.

#### [MEDIA] Descrição da V1005 contaminada por resíduo de copy/paste ('1- Masculino / 2- Feminino') nas quatro planilhas do layout
...
**Estado hoje: persiste.** Extraído do Documentacao.zip cuja cópia local tem exatamente o Content-Length que o FTP devolve hoje (10.711.779) e Last-Modified 13/03/2018. Os dados da V1005 em si estão corretos (valores 1 a 8 em todas as UFs, nenhum fora do domínio) — o defeito é só na descrição.

#### [BAIXA] Idades impossíveis de emigrantes (V0304) e ano de partida igual ao ano de nascimento em partidas pré-1950
...
**Estado hoje: persiste.** Mesmos 28 zips com Last-Modified 17/08/2016 e MD5 idêntico ao local; único log de atualização é de 11/03/2016 e trata só da V1005. Os 53.777 registros do bruto aparecem intactos no parquet publicado em censobr v0.5.0 (peso total 560.532,76 nos dois).

#### [BAIXA] Registro de mortalidade sem nenhuma informação de idade e sem marca de 'ignorado'
...
**Estado hoje: persiste.** SP1.zip no FTP: Last-Modified 17/08/2016, Content-Length 136.561.102, idêntico à cópia local. Nenhum log de atualização posterior a 11/03/2016.

#### [BAIXA] Arquivo de trava do LibreOffice com usuário e hostname internos do IBGE vazado dentro do Documentacao.zip oficial
...
**Estado hoje: persiste.** O Documentacao.zip publicado hoje no FTP tem Content-Length 10.711.779 e Last-Modified 13/03/2018 — exatamente a cópia que abri e onde o arquivo de trava está presente (53 arquivos no zip).

#### [BAIXA] Nomes de Unidade da Federação corrompidos no arquivo oficial de contagem de áreas de ponderação
...
**Estado hoje: persiste.** Arquivo extraído do Documentacao.zip cujo tamanho no FTP (10.711.779) e Last-Modified (13/03/2018) conferem com a cópia local.

#### [BAIXA] Layout remete a três arquivos de tabela de códigos que não existem no pacote de documentação
...
**Estado hoje: persiste.** Listagem completa do Documentacao.zip publicado hoje (Content-Length 10.711.779, Last-Modified 13/03/2018): 53 arquivos, nenhum com os nomes citados no layout.

#### [BAIXA] Duas cópias concorrentes da tabela de países no mesmo pacote, com nomes que diferem só por acento e caixa
...
**Estado hoje: persiste.** Ambos os arquivos estão no Documentacao.zip publicado hoje no FTP (Content-Length 10.711.779, Last-Modified 13/03/2018).

#### [BAIXA] Revisão de 2018 da documentação não registrada em nenhum log de atualização
...
**Estado hoje: persiste.** unzip -l nos 28 zips locais, cujos tamanhos e datas conferem com o FTP (SP2_RM.zip: Last-Modified 17/08/2016, Content-Length 66.923.314).

### 2022 — 13 itens (1 de gravidade alta)

#### [ALTA] V0006 do Básico troca de escala entre o preliminar e o definitivo mantendo o mesmo rótulo (proporção 0–1 apresentada como "Percentual")
...
**Estado hoje: persiste.** Baixei o dicionário atual de https://ftp.ibge.gov.br/Censos/Censo_Demografico_2022/Agregados_por_Setores_Censitarios/dicionario_de_dados_agregados_por_setores_censitarios_20260520.xlsx e o pacote preliminar de https://ftp.ibge.gov.br/Censos/Censo_Demografico_2022/Agregados_por_Setores_Censitarios_preliminares/agregados_por_setores_csv/BR/ em 2026-09-12; comparei as distribuições no CSV bruto do definitivo (data_raw/tracts/2022/csv) e no CSV preliminar, e reconstruí a contagem de imputados por município nos dois.

#### [MEDIA] 11 setores com V0006 > 1 — mais domicílios imputados do que domicílios existentes
...
**Estado hoje: persiste.** Layout baixado do FTP em 2026-09-12 (Documentacao/Layout e dicionário/); cabeçalho dos 27 CSVs comparado ao layout variável a variável; identidade MP0410 == MP0411 testada no parquet nacional de 21.538.508 linhas.

#### [MEDIA] Código 9 presente nos dados e não declarado no layout em três marcas de imputação (MP1010, MF0190, MF0200)
...
**Estado hoje: persiste.** Parser das categorias declaradas em cada rótulo do layout de 28/08/2026 confrontado com os valores observados nos parquets nacionais (265 colunas testadas nas 4 tabelas).

#### [MEDIA] TXT e CSV da mesma UF e tabela não estão alinhados linha a linha
...
**Estado hoje: persiste.** Baixei txt/14_RR.zip e txt/16_AP.zip do FTP em 2026-09-12, parseei pelas posições do layout público e comparei coluna a coluna com os CSVs já em data_raw; larguras das linhas (113/253/69/43) batem exatamente com a última posição declarada no layout.

#### [BAIXA] F0220 = 5 e F0150 = 11: categorias observadas nos dados e ausentes do layout
...
**Estado hoje: persiste.** Comparação automática entre as categorias extraídas dos rótulos do layout de 28/08/2026 e os valores observados em todas as 265 variáveis das 4 tabelas nos parquets nacionais; inspeção do domicílio 7061191 e dos 87 registros com F0220=5.

#### [BAIXA] 13 variáveis com branco frequente sem a categoria "Branco"/"Não aplicável" no layout
...
**Estado hoje: persiste.** Cruzamento automático rótulo-por-rótulo (busca por "branco" e "não aplicável") contra a contagem de NA nos parquets nacionais; totais quilombolas por UF conferidos no agregado de setor de quilombolas (Brasil 1.317.569 no universo contra 1.324.414 na amostra pública).

#### [BAIXA] Dois setores do Rio Grande do Sul sem qualquer geografia no Básico
...
**Estado hoje: persiste.** grep direto nas duas linhas do CSV do zip 20260520 baixado em 2026-09-12; varredura de NA por coluna nos 468.099 setores (CD_MUN: 2 NA; CD_UF e CD_REGIAO: 0 NA).

#### [BAIXA] Nome de arquivo com caractere não-ASCII em UTF-8 dentro de um índice servido em ISO-8859-1
...
**Estado hoje: persiste.** Leitura do índice HTML do diretório em 2026-09-12 e HEAD no zip (HTTP 200, Last-Modified Thu, 17 Apr 2025 13:02:39 GMT); inspeção do nome do arquivo extraído em disco via Python (repr mostra ).

#### [BAIXA] Diretório de Quilombolas duplicado no FTP, com duas publicações do mesmo produto a três dias de distância
...
**Estado hoje: persiste.** Listagem dos dois diretórios e de Tabelas_de_resultados em cada um, no FTP, em 2026-09-12.

#### [BAIXA] Agregados por setor de 2022 espalhados por três diretórios distintos do FTP
...
**Estado hoje: persiste.** Listagem completa dos três diretórios no FTP em 2026-09-12; o código de download deste projeto (R/census_tracts_2022.R) precisa de dois endpoints varridos mais uma URL fixa por causa disso.

#### [BAIXA] V0005 (média de moradores) perdeu precisão do preliminar para o definitivo
...
**Estado hoje: persiste.** Leitura dos dois CSVs e contagem das casas decimais em 2026-09-12.

#### [BAIXA] P0180 = 99 "Ignorado" é indistinguível da supressão de confidencialidade
...
**Estado hoje: persiste.** Contagem cruzada nos 21.538.508 registros do parquet nacional da amostra pública construído a partir dos 27 CSVs de 28/08/2026.

---

## Panorama dos logs de atualização do IBGE

Os logs são a prova do que o Instituto reconheceu publicamente — e, por
contraste, do que nunca reconheceu.

### Microdados da amostra do Censo Demográfico de 1970 (FTP do IBGE)

Não existe NENHUM log de atualização para 1970. A árvore https://ftp.ibge.gov.br/Censos/Censo_Demografico_1970/ contém uma única subpasta (Microdados/) e esta contém um único arquivo (Microdados_Censo_Demografico_1970_Amostra.zip). Não há 'Atualizacoes.txt', 'N_Atualizacoes_AAAAMMDD.txt' nem 'leia_me.txt' em nenhum nível. O mesmo vale para 1980 e 1991: https://ftp.ibge.gov.br/Censos/Censo_Demografico_1980/Microdados/ e .../Censo_Demografico_1991/Microdados/ têm cada um apenas o zip da amostra, sem log. O arquivo geral https://ftp.ibge.gov.br/Censos/leia_me.txt (881 bytes, Last-Modified 21/06/2018) é um texto descritivo genérico que trata apenas de 1991 e 2000 e não menciona 1970 nem qualquer correção.

O CONTRASTE É O ARGUMENTO MAIS FORTE DA CARTA. O IBGE mantém, sim, esses logs para microdados de censo -- só não para 1970. Em https://ftp.ibge.gov.br/Censos/Censo_Demografico_2000/Microdados/ existe o arquivo 2_Atualizacoes_20170908.txt (482 bytes, Last-Modified 08/09/2017), cujo conteúdo integral é:

  "19/06/2015 - Foi identificado que partes de alguns registros estavam corrompidos. Os arquivos foram substituídos.
   09/03/2016 - Foi identificado que que os arquivos de atividade e ocupação necessitavam incompletos e que era necessário incluir novos códigos na documentação que compatibiliza os códigos de 2000 e 1991. Foi identificado que a variável V0300 não estava no arquivo de domicílio.
   08/09/2017 - Foi identificado que a variável V0300 não estava no arquivo de domicílio."

A primeira entrada descreve EXATAMENTE a mesma classe de defeito que encontramos em 1970 -- "partes de alguns registros estavam corrompidos" -- e registra que o Instituto o reconheceu e substituiu os arquivos. Ou seja, há precedente institucional direto: o que a carta pede para 1970 é o que o IBGE já fez para 2000 em junho de 2015. A mesma prática existe fora dos censos (ex.: ftp.ibge.gov.br/Trabalho_e_Rendimento/Pesquisa_Nacional_por_Amostra_de_Domicilios_continua/Anual/Microdados/atualiza

### Microdados da amostra do Censo Demográfico de 1980 (republicação em DBF no FTP do IBGE, arquivo único Microdados_Censo_D

Para 1980 não existe nenhum log de atualização. A árvore https://ftp.ibge.gov.br/Censos/Censo_Demografico_1980/ contém apenas Microdados/, e essa pasta contém apenas Microdados_Censo_Demografico_1980_Amostra.zip -- nenhum arquivo "Atualizacoes". O /Censos/leia_me.txt (Last-Modified 21/06/2018, 881 bytes) trata só de 1991 e 2000 e não menciona 1980. O Leiame.txt dentro do próprio zip tem 473 bytes e só explica a nomenclatura CD80PESXX/CD80DOMXX e aponta o Documentação.xls; não registra revisão alguma. Mesma ausência em 1970 e 1991, que também têm um único zip sem log.

Mas o IBGE tem a prática institucional de publicar esses logs, o que torna a ausência em 1980 notável e a correção exigível:

- https://ftp.ibge.gov.br/Censos/Censo_Demografico_2000/Microdados/2_Atualizacoes_20170908.txt (Last-Modified 08/09/2017, 482 bytes), conteúdo integral: "19/06/2015 - Foi identificado que partes de alguns registros estavam corrompidos. Os arquivos foram substituídos. / 09/03/2016 - Foi identificado que que os arquivos de atividade e ocupação necessitavam incompletos e que era necessário incluir novos códigos na documentação que compatibiliza os códigos de 2000 e 1991. Foi identificado que a variável V0300 não estava no arquivo de domicílio. / 08/09/2017 - Foi identificado que a variável V0300 não estava no arquivo de domicílio."

- https://ftp.ibge.gov.br/Censos/Censo_Demografico_2010/Resultados_Gerais_da_Amostra/Microdados/1_Atualizacoes_20160311.txt, conteúdo integral: "11/03/2016 - a variável v1005 - SITUAÇÃO DO SETOR foi incluída nos arquivos de DOMICÍLIO, PESSOA, EMIGRAÇÃO e MORTALIDADE"

O precedente de 19/06/2015 é especialmente útil para a carta: o IBGE já reconheceu e substituiu arquivos de microdados por "partes de alguns registros estavam corrompidos" -- exatamente a natureza do que se encontrou agora em Goiás e Curitiba em 1980.

Estado do arquivo de 1980 em 12/09/2026 (HEAD): Last-Modified Thu, 09 Jan 2025 22:08:20 GMT; Content-Length 544.850.882; ETag "2079c3c2-62b

### Microdados da amostra do Censo Demográfico de 1991 — https://ftp.ibge.gov.br/Censos/Censo_Demografico_1991/Microdados/Mi

Não existe nenhum arquivo de log de atualização para 1991. Varri a árvore inteira em 2026-09-12: https://ftp.ibge.gov.br/Censos/Censo_Demografico_1991/ contém apenas Leia_me.txt e cinco subpastas (Indice_de_Gini, Microdados, Municipios_maiores_50_mil_hab, Populacao_Residente_Urbana_Rural, Sexo_Populacao_Residente); nenhuma delas traz arquivo com nome do tipo "Atualizacoes", "1_Atualizacoes_AAAAMMDD.txt" ou equivalente. A pasta Microdados tem um único item, o zip. O Leia_me.txt da raiz de 1991 e o leia_me.txt da raiz de /Censos/ descrevem apenas o conteúdo temático das tabelas agregadas e não mencionam os microdados nem qualquer correção. As pastas de microdados de 1970 e 1980 também não têm log. O único registro temporal disponível é indireto e converge para uma publicação única, sem revisão posterior: (a) HTTP Last-Modified do zip = Thu, 09 Jan 2025 22:07:17 GMT, Content-Length 673.659.331, ETag "282739c3-62b4d338d8eef" — conferidos duas vezes durante esta varredura, no início e no fim, sem alteração, e idênticos à cópia local (MD5 f41a9bf306b84a538c8dfc18b4ffcab2); (b) as 35 entradas do zip têm data 2025-01-09 entre 18:50 e 18:52; (c) o carimbo interno "última atualização" dos 27 DBFs é 2013-09-09 (SP, 2013-09-10), ou seja, os arquivos de dados foram gerados em setembro de 2013 e só publicados no FTP em janeiro de 2025; (d) o LEIA_ME.DOC tem data de criação 1996-09-27 e última gravação 2013-10-10, com impressão em 2013-10-10 — é o leia-me do CD-ROM de 1996, editado em 2013 e não revisto desde. Os zips de 1970 e 1980 foram publicados no mesmo lote (Last-Modified 2025-01-09 22:08:20 e 22:08:30 GMT). Conclusão para a carta: não há nada que o IBGE tenha reconhecido ou corrigido publicamente a respeito de 1991; tudo o que está relatado aqui vale contra a distribuição vigente.

### Microdados da amostra do Censo Demografico 2000 — https://ftp.ibge.gov.br/Censos/Censo_Demografico_2000/Microdados/ (27 

O unico log da edicao e https://ftp.ibge.gov.br/Censos/Censo_Demografico_2000/Microdados/2_Atualizacoes_20170908.txt (482 bytes, Last-Modified Fri, 08 Sep 2017 18:43:23 GMT). Transcricao integral (4 linhas): "19/06/2015 - Foi identificado que partes de alguns registros estavam corrompidos. Os arquivos foram substituidos." / "09/03/2016 - Foi identificado que que os arquivos de atividade e ocupacao necessitavam incompletos e que era necessario incluir novos codigos na documentacao que compatibiliza os codigos de 2000 e 1991." / "Foi identificado que a variavel V0300 nao estava no arquivo de domicilio." / "08/09/2017 - Foi identificado que a variavel V0300 nao estava no arquivo de domicilio." Leitura: (a) a ultima atualizacao reconhecida e de 08/09/2017, exatamente a data do Last-Modified de todos os 27 zips, do zip de documentacao e do proprio log — portanto nada na pasta foi tocado nos ultimos 9 anos; (b) a correcao do V0300 no arquivo de domicilio foi de fato aplicada: a variavel esta documentada em "SAS/LE DOMIC.sas" na posicao @39 (8 digitos, "CONTROLE") e esta presente nos dados — usei-a para cruzar domicilio x pessoa nas 27 UFs, com zero orfaos; (c) o log NAO menciona nenhum dos defeitos verificados aqui — nem a duplicata da Paraiba dentro de RN.zip, nem os zips aninhados da BA, nem o 0x1A de MG, nem o descompasso da planilha de areas de ponderacao; (d) a entrada de 19/06/2015 sobre "registros corrompidos substituidos" nao pode ser auditada por fora: as datas internas dos arquivos sao de 2003 (maioria), 2003-09-19 (MG), 2003-10-09 (PE, SC e Dom35 de SP), 2007-03 (todos os FAMI), 2008-09-24 (o PES29.zip da BA) e 2010-04-28 (Pes35 de SP), e nao existe copia anterior a 2015 para comparar. No diretorio-pai (https://ftp.ibge.gov.br/Censos/Censo_Demografico_2000/) ha um leia_me.txt (976 bytes, LM 17/08/2016), mas ele trata dos Resultados do Universo, nao dos microdados, e nao registra correcao alguma. Nao existe nenhum outro arquivo de log ou "Atualizacoes" na pasta 

### Censo Demográfico 2010 — Agregados por Setores Censitários (Resultados do Universo)

Arquivo: https://ftp.ibge.gov.br/Censos/Censo_Demografico_2010/Resultados_do_Universo/Agregados_por_Setores_Censitarios/1_Atualizacoes_20260615.txt — 2.598 bytes, Last-Modified 2026-06-15 08:55. É o único log do eixo; os diretórios-pai (Resultados_do_Universo/ e Censo_Demografico_2010/) não têm outro. Contém 14 entradas, da mais recente para a mais antiga.

O QUE O LOG RECONHECE (transcrição das entradas relevantes):
- 15/06/2026 — "Descrição: A variável Cod_setor (1ª coluna) dos arquivos em formato CSV estavam corrompidas. Ações: Os arquivos foram corrigidos e substituídos." É a entrada que explica a republicação das 28 UFs nessa data.
- "15/19/2025" (sic — mês 19; pelo contexto e pela data interna dos arquivos, 15/09/2025) — "Foi verificado que no arquivo 'Pessoa02' de Goiás, as colunas referêntes às variáveis de V001 a V099 foram nomeadas omitindo um 0. As colunas forma renomeadas e os arquivos nos formatos CSV e XLS foram substituídos."
- 11/12/2024 — "Foi verificado um problema no arquivo Domicilio01_RS.xls refrente ao Rio Grande do Sul. Um novo arquivo foi gerado a partir do arquivo no formato CSV, também disponível, que estava correto."
- 30/10/2023 — "Foi descoberto que na UF de Goiás haviam dois arquivos com problema. Por precaução optou-se pela substituição completa dos arquivos."
- 19/02/2020 — substituição de Entorno01 a Entorno05 de Pernambuco, em CSV.
- 23/08/2019 — substituição de Domicilio02 de SP-Capital, em CSV e XLS.
- 07/02/2019 — substituição dos arquivos de SP-Exceto a Capital, por ajuste em Praia Grande (redistribuição de setores nos bairros).
- 16/10/2017 — substituição de Domicilio02 em CSV de todas as UFs: "Os códigos de setores estavam incompletos."
- 15/12/2016 — substituição de Entorno01 em CSV de CE, DF e MG.
- 28/07/2015 — Domicilio02 de SP-Capital com código de setor incompleto.
- 22/07/2015 — zip de Alagoas substituído, dois arquivos corrompidos na compactação.
- 02/07/2015 — atualização das categorias da variável Tipo de setor na Do

### Microdados da amostra do Censo Demográfico 2010 (28 zips por UF + Documentacao.zip), FTP/IBGE: /Censos/Censo_Demografico

Único log de atualização dos microdados de 2010: https://ftp.ibge.gov.br/Censos/Censo_Demografico_2010/Resultados_Gerais_da_Amostra/Microdados/1_Atualizacoes_20160311.txt — 121 bytes, ISO-8859-1, sem quebra de linha, com uma única entrada, transcrita integralmente: "11/03/2016 - a variável v1005 - SITUAÇÃO DO SETOR foi incluída nos arquivos de DOMICÍLIO, PESSOA, EMIGRAÇÃO e MORTALIDADE".

Consequência para a carta: em dez anos o IBGE reconheceu UMA alteração nos microdados da amostra de 2010, e ela foi um acréscimo de variável, não uma correção. Nenhum dos defeitos abaixo foi reconhecido ou sanado.

Datas que amarram a linha do tempo: os .txt dentro dos zips estão gravados em 04/03/2016, os diretórios dos zips em 11/03/2016 (mesma data do log) e os 28 zips foram republicados no FTP em 17/08/2016 (Last-Modified uniforme, entre 14:06:25 e 14:07:11 GMT). O Documentacao.zip é posterior e independente: Last-Modified 13/03/2018, com "Descrição das variáveis" (.doc e .pdf) gravados em 02/03/2018 — revisão sem registro em log algum.

Varri procurando outros logs em /Censos/, /Censos/Censo_Demografico_2010/, /Censos/Censo_Demografico_2010/Resultados_Gerais_da_Amostra/, .../Unidades_da_Federacao/ e .../Resultados_Gerais_da_Amostra_areas_de_ponderacao/ com filtro atualiz|errata|leia|readme|nota|correc. Resultado: apenas /Censos/leia_me.txt (21/06/2018, trata de 1991 e 2000, irrelevante) e dois errata na pasta-mãe da amostra:
- errata_migracao.pdf (157.168 bytes, Last-Modified 17/08/2016) — substitui o capítulo "Migração" da publicação Resultados Gerais da Amostra, com a Tabela 7 de imigrantes/emigrantes/saldo por UF (Brasil 1995/2000 = 5.196.093 e 2005/2010 = 4.643.754 migrantes internos). Corrige texto e tabela da publicação, NÃO os microdados.
- errata_deslocamento.pdf (16.971 bytes, Last-Modified 17/08/2016) — corrige números nas páginas 105, 106, 108 e 109 do capítulo Deslocamento (ex.: "onde se lê 432 mil, leia-se 433 mil"; "onde se lê 428 mil, leia-se 2,5 milhões"). Tamb

### Censo 2022 — microdados da amostra de acesso público (31/08/2026) e agregados por setor censitário (definitivos, prelimi

NÃO EXISTE nenhum arquivo de log de atualização em toda a árvore do Censo 2022. Varri recursivamente https://ftp.ibge.gov.br/Censos/Censo_Demografico_2022/ até três níveis de profundidade: 108 diretórios, 376 arquivos. Nenhum "1_Atualizacoes_AAAAMMDD.txt", nenhum "Atualizacoes.txt", nenhuma errata, nenhum changelog. Os únicos documentos com cara de leia-me são Microdados_e_Areas_de_Ponderacao/Documentacao/Leia-me.pdf (39 KB, 2026-08-19) — que é documentação do produto, não histórico de correções — e arquivos "indice_de_tabelas.txt"/"indice_de_cartogramas.txt" dentro dos produtos temáticos de indígenas e quilombolas, que são listagens de conteúdo. Não há leia_me.txt na raiz de 2022 (1991, 2000 e a raiz /Censos/ têm um).

Em 2022 o IBGE sinaliza republicação apenas por um sufixo de data no nome do arquivo E REMOVE o arquivo superado. Verificado hoje: Agregados_por_setores_basico_BR_20250417.zip devolve HTTP 404, assim como Agregados_por_setores_basico_BR.zip; só existe Agregados_por_setores_basico_BR_20260520.zip (200, Last-Modified Wed, 20 May 2026 13:37:23 GMT). Isso significa que (a) não há como saber o que mudou e (b) não há como reproduzir uma construção anterior. Os sufixos hoje visíveis no diretório de setores: basico_BR_20260520, caracteristicas_domicilio2_BR_20250417, caracteristicas_domicilio3_BR_20250417, e renda_responsavel_BR_20260508 (em outro diretório) — os demais 13 não têm sufixo nenhum e datam de 2024-11-12.

O contraste com 2010 é gritante e vale citar na carta como o padrão que o próprio Instituto sabe manter: https://ftp.ibge.gov.br/Censos/Censo_Demografico_2010/Resultados_do_Universo/Agregados_por_Setores_Censitarios/1_Atualizacoes_20260615.txt (2,5 KB, 2026-06-15) lista 13 correções desde 2015, cada uma com data, descrição e ação. Trecho da entrada mais recente: "15/06/2026 — Descrição: A variável Cod_setor (1ª coluna) dos arquivos em formato CSV estavam corrompidas. Ações: Os arquivos foram corrigidos e substituídos." — e, de fato, os 27 zips 

### 1960 e o panorama dos logs de atualização do IBGE (varredura completa da árvore /Censos/ do FTP)

A árvore inteira de /Censos/ (47.748 entradas indexadas em 12/09/2026) contém exatamente TRÊS arquivos de log de atualização, e mais nenhum.

(1) https://ftp.ibge.gov.br/Censos/Censo_Demografico_2000/Microdados/2_Atualizacoes_20170908.txt — 482 bytes, 08/09/2017, MD5 0e58f0e80a4875b2f00e2a9d97033e7d. Três entradas: "19/06/2015 - Foi identificado que partes de alguns registros estavam corrompidos. Os arquivos foram substituídos."; "09/03/2016 - Foi identificado que que os arquivos de atividade e ocupação necessitavam incompletos e que era necessário incluir novos códigos na documentação que compatibiliza os códigos de 2000 e 1991. Foi identificado que a variável V0300 não estava no arquivo de domicílio."; "08/09/2017 - Foi identificado que a variável V0300 não estava no arquivo de domicílio." A mesma falha aparece duas vezes, com dezoito meses de intervalo — a correção de 2016 não pegou. Hoje está sanada: nos arquivos atuais (08/09/2017) a V0300 ocupa as posições 39–46 do registro de domicílio e está preenchida — em Dom14.txt (RR), 5.000 valores distintos nas primeiras 5.000 linhas, zero brancos, e batendo com o mesmo campo em Pes14.txt e FAMI14.TXT. O prefixo "2_" não indica que exista um "1_Atualizacoes": esse lugar é ocupado por 1_Documentacao_20170908.zip.

(2) https://ftp.ibge.gov.br/Censos/Censo_Demografico_2010/Resultados_Gerais_da_Amostra/Microdados/1_Atualizacoes_20160311.txt — 121 bytes, MD5 7ad6737fab8535d2f69509d76a18dbb3. Uma única linha: "11/03/2016 - a variável v1005 - SITUAÇÃO DO SETOR foi incluída nos arquivos de DOMICÍLIO, PESSOA, EMIGRAÇÃO e MORTALIDADE". É a última alteração registrada nos microdados de 2010; os 29 zips do diretório estão todos em 17/08/2016 e o Documentacao.zip em 13/03/2018.

(3) https://ftp.ibge.gov.br/Censos/Censo_Demografico_2010/Resultados_do_Universo/Agregados_por_Setores_Censitarios/1_Atualizacoes_20260615.txt — 2.598 bytes, Last-Modified 15/06/2026 11:55:33 GMT, MD5 b8ee8516c0fe6fb04626064ae232ab03. É o único log vivo do 

---

## O que foi varrido e saiu limpo

Registrado para a carta não parecer seletiva: estes eixos foram varridos com o
mesmo método e não produziram achado.

**Microdados da amostra do Censo Demográfico de 1970 (FTP do IBGE)** — Varreduras que saíram limpas, importantes para a carta não parecer seletiva:

1) COMPRIMENTO DE LINHA NOS OUTROS 25 ARQUIVOS -- verifiquei todos, não uma amostra. DAMO70AC, DAMO70AM, DAMO70AP, DAMO70DF, DAMO70GO, DAMO70MT, DAMO70PA, DAMO70PR, DAMO70RO, DAMO70RR, DAMO70RS, DAMO70SC, Damo70BA, Damo70CE, Damo70ES, Damo70FN, Damo70GB, Damo70MA, Damo70MG, Damo70PB, Damo70RJ, Damo70RN, Damo70SE, Damo70SP e Damo70PI têm 100% das linhas com exatamente 76 caracteres. Zero anomalias. Vale registrar que isso inclui os sete arquivos do mesmo lote de novembro de 2005 que AL e PE (BA, CE, PB, MA, RN, SE, FN), todos íntegros -- portanto a data de republicação, sozinha, não explica o defeito, e a carta não 

**Microdados da amostra do Censo Demográfico de 1980 (republicação em DBF no FTP do IBGE, arquivo únic** — Varri e saiu limpo:

- Integridade estrutural dos 52 DBF. Layout idêntico nas 26 UFs (domicílio: 26 campos, registro de 63 bytes; pessoa: 61 campos, registro de 165 bytes). Nenhum registro marcado como deletado em nenhum arquivo. Tamanho de arquivo = cabeçalho + n_registros x tamanho_registro em todos os 52 (só falta o marcador 0x1A de fim de arquivo, irrelevante). Nenhum arquivo truncado.

- Ligação pessoa -> domicílio. Zero pessoas órfãs: as 29.378.455 pessoas casam com um domicílio existente pela chave (UF, MUNIC, NDOM). CONTADOM é sequência 0..n-1 sem buracos dentro de cada um dos 3.990 municípios.

- Contagens por UF. Fator de expansão implícito entre 3,74 e 3,99 nos domicílios e entre 

**Microdados da amostra do Censo Demográfico de 1991 — https://ftp.ibge.gov.br/Censos/Censo_Demografic** — Varri e saiu limpo, e isto é bastante coisa. Integridade do pacote: o zip passa no teste de CRC das 35 entradas (unzip -t, "No errors detected"); os dois PDFs (Manual do Recenseador, Questionário da Amostra) abrem com assinatura %PDF-1.3 válida. Integridade binária dos DBFs: nos 27 arquivos o cabeçalho declara um número de registros que reproduz o tamanho do arquivo byte a byte (tamanho - cabeçalho - nregistros x 493 = 1 em todos, o marcador 0x1A de fim de arquivo), o layout é rigorosamente idêntico (141 campos, 493 bytes por registro, mesmos nomes, tipos, tamanhos e decimais — zero divergência entre UFs), e o terminador de cabeçalho está correto. Nenhum registro fragmentado ou de compriment

**Microdados da amostra do Censo Demografico 2000 — https://ftp.ibge.gov.br/Censos/Censo_Demografico_2** — Varri e saiu limpo: (1) CONTAMINACAO ENTRE UFs — os 27 zips foram listados um a um; so RN.zip tem arquivos de outra UF. Alem disso li o campo V0102 (posicoes 1-2) de TODAS as ~31,3 milhoes de linhas dos 81 arquivos: cada arquivo traz um unico codigo de UF, o da propria pasta, sem uma linha sequer de UF estranha (a unica excecao e a linha-fantasma de 1 byte de MG). (2) ZIP ANINHADO — so BA.zip; os outros 26 entregam os tres .txt direto. (3) MUNICIPIOS — 5.507 codigos distintos no pais, exatamente o numero de municipios do Censo 2000, com as contagens por UF corretas (MG 853, SP 645, RS 467, BA 415, PR 399, DF 1...); em 100% dos registros os dois primeiros digitos do V0103 coincidem com o V010

**Censo Demográfico 2010 — Agregados por Setores Censitários (Resultados do Universo)** — Varreduras que saíram limpas, e que convém citar na carta para mostrar que a crítica é pontual e não uma desconfiança geral do produto:

1. XLS contra CSV, Acre, lote atual, todas as 26 tabelas: 874 linhas nos dois formatos em todas elas, mesmos nomes de coluna, mais de 3,44 milhões de células numéricas comparadas, 0 divergentes, 0 NAs assimétricos, 0 colunas presentes só em um dos formatos. A regeração dos CSV em 15/06/2026 não introduziu divergência de conteúdo em relação aos XLS de 2012, que não foram tocados.

2. Integridade das chaves no lote atual: nos 26 CSV do Acre, 874 linhas e 874 Cod_setor distintos em cada um, e nenhuma linha com número de campos diferente do cabeçalho.

3. Deslo

**Microdados da amostra do Censo Demográfico 2010 (28 zips por UF + Documentacao.zip), FTP/IBGE: /Cens** — Varredura completa, byte a byte, dos 112 arquivos (12.273.564.384 bytes) dos 28 zips. Tudo abaixo saiu LIMPO — é importante para a carta não parecer seletiva, e também porque contrasta com 1970/1980 e com os setores de 2010:

ESTRUTURA DOS ARQUIVOS
- Comprimento de registro: todos os 26.993.136 registros têm exatamente o comprimento do layout (Pessoas 540, Domicílios 172, Emigração 74, Mortalidade 66, + CRLF). min == max == comprimento nominal em cada um dos 112 arquivos; zero linha curta ou longa. O tamanho de todos os 112 arquivos é divisível exatamente pelo comprimento do registro.
- Zero caractere não-ASCII em 12,27 GB (procurei explicitamente por lixo tipo o "ÿ" que aparece nos XLS dos 

**Censo 2022 — microdados da amostra de acesso público (31/08/2026) e agregados por setor censitário (** — O que varri e saiu limpo — é a parte que dá credibilidade ao resto da carta:

MICRODADOS (108 CSVs, 4 tabelas × 27 UFs, 8,5 GB lidos integralmente com awk):
- Cabeçalho idêntico nos 27 arquivos de cada tabela (1 único hash por tabela). Domicílios 55 colunas, Pessoas 168, Família 23, Mortalidade 14.
- Zero linhas com número de campos diferente do declarado, em nenhum dos 108 arquivos, nas 29.947.916 linhas de dado.
- A UF (*0020) e a região (*0010) são constantes dentro de cada arquivo e sempre coincidem com o nome do arquivo. Nenhuma UF trocada, nenhum registro migrado.
- Layout × CSV: 55/168/23/14 variáveis, mesmos nomes, MESMA ORDEM; posições de largura fixa contíguas sem buraco e largura 

**1960 e o panorama dos logs de atualização do IBGE (varredura completa da árvore /Censos/ do FTP)** — Varrido e limpo:

1) Nenhum outro log. Crawler recursivo de /Censos/ (1970, 1980, 1991, 2000, 2010, 2022) com ~1.000 requisições de índice e 47.748 entradas coletadas, filtrado por 'atualiza|leia.?me|read.?me|errata|retific|corrig|changelog|historico|nota.?tecn'. Além dos três logs e dos dez leia_me descritivos, os únicos acertos são nomes de arquivo de dado e duas erratas em PDF de 2010 (Resultados_Gerais_da_Amostra/errata_deslocamento.pdf, 17 KB, e errata_migracao.pdf, 153 KB, ambas 17/08/2016), que são erratas de publicação impressa e não de microdado.

2) Nenhum vestígio de 1960 em nenhum lugar do FTP. Além do 404 no diretório, checadas e descartadas /seculoxx/, /Informacoes_Gerais_e_Ref

---

## Incertezas declaradas

**Microdados da amostra do Censo Demográfico de 1970 (FTP do IBGE)** — 1) Não é possível saber se o toque de 09/01/2025 alterou conteúdo em relação a algo anterior: nossa cópia de referência foi baixada em 05/05/2026, ou seja, DEPOIS daquela data. O que está provado é que o arquivo servido hoje carrega o defeito. O fato de os zips de 1970, 1980 e 1991 terem Last-Modified dentro de 73 segundos uns dos outros aponta fortemente para re-sincronização de servidor, mas é inferência, não prova documental.\n\n2) Não é possível determinar, a partir do arquivo, QUAL etapa de produção gerou o deslocamento (conversão de fita para disco, transferência, edição posterior). O conjunto de evidências -- blocos de tamanho fixo movidos, conservação do total de bytes, concentração 

**Microdados da amostra do Censo Demográfico de 1980 (republicação em DBF no FTP do IBGE, arquivo únic** — 1) Procedência da amostra de comparação. A "distribuição anterior" contra a qual medi as regressões de Curitiba e Goiás é a amostra preparada que o projeto usa (CSVs de 2018, hoje no release_legacy). Não tenho documento formal de origem. O que sustenta tratá-la como cópia fiel de uma distribuição do IBGE: (a) fora dos 48 municípios afetados ela bate 100% registro a registro com o DBF, inclusive nas sentinelas 999999 e 99, isto é, não é um arquivo limpo; (b) seus dois pesos batem exatamente com o SIDRA (25.210.639 domicílios e 119.011.052 pessoas); (c) seu contador global de domicílio cobre exatamente 6.886.803 + 80 posições. Ainda assim, se ela fosse uma reconstrução de terceiro, o enquadram

**Microdados da amostra do Censo Demográfico de 1991 — https://ftp.ibge.gov.br/Censos/Censo_Demografic** — Quatro pontos que não fecham com certeza absoluta. (1) Procedência dos CSVs de 2018. O achado de Ariquemes prova que a versão preparada da amostra que circula (e que nosso pipeline usa) está incompleta ali e que o DBF do FTP está certo; mas não estabeleci se aqueles CSVs são produto do IBGE ou repacotamento de terceiro. Se forem do IBGE, é um defeito adicional a relatar; se não, é só a confirmação de que o DBF é a fonte melhor nesse ponto. Vale checar antes de incluir na carta. (2) Os 91 municípios com pesos que não fecham. A calibração é claramente municipal — 4.400 dos 4.491 batem com precisão de oito casas decimais — o que torna difícil explicar os 91 restantes como escolha metodológica. 

**Microdados da amostra do Censo Demografico 2000 — https://ftp.ibge.gov.br/Censos/Censo_Demografico_2** — 1) O buraco de 1 domicilio particular na area 2610707999002 (Recife AED 02) nao tem causa provada. Nao ha pessoa orfa em PE, entao ou a planilha esta 1 unidade errada, ou o domicilio sumiu junto com os moradores dele — e nesse caso a perda seria invisivel por dentro do arquivo. E a unica area entre 9.336 com essa divergencia, e e a mesma que abriga o unico registro truncado do pais; a coincidencia e forte mas nao e prova. 2) Nao sei se o IBGE considera a "Lista das Areas de Ponderacao-Brasil.xls" um documento historico (retrato da publicacao original de 2000) em vez de documentacao corrente. Nada no arquivo nem no zip diz isso, e ele foi republicado em 08/09/2017 junto com os microdados, ent

**Censo Demográfico 2010 — Agregados por Setores Censitários (Resultados do Universo)** — 1. Não baixei inteiros os zips de São Paulo (175 MB e 461 MB) nem os de RS, ES e GO, para não sobrecarregar o FTP. A evidência do lado CSV vem do cabeçalho completo mais as primeiras centenas de linhas de cada membro, obtidas por HTTP Range com inflação parcial do fluxo deflate — o cabeçalho é integral, então a afirmação sobre os nomes das colunas é certa; a prova aritmética do shift em SP_Capital foi feita sobre os 876 setores que couberam na amostra lida, não sobre os 18.363. O teste com a base inteira já havia sido feito em maio de 2026 (84 de 85 identidades exatas em SP1 e SP2) e está em references/relatorio_pessoa02_sp_shift.md.

2. A evidência do lado XLS vem das cópias locais em data_

**Microdados da amostra do Censo Demográfico 2010 (28 zips por UF + Documentacao.zip), FTP/IBGE: /Cens** — 1) Classificar as idades de 115+ como "defeito" pressupõe que caberia ao IBGE aplicar crítica de idade máxima. O Instituto pode responder que preserva a declaração do informante. O argumento forte da carta não é o valor isolado, e sim a FORMA da distribuição (mais casos em 128 anos do que em 118) somada a M6033=2 em 100% dos casos e V6040=1 (data de nascimento completa disponível) em 68 de 75 — ou seja, o erro é de século no ano de nascimento e é mecanicamente detectável. Vale enquadrar como "crítica não aplicada", não como "dado errado".

2) Heaping de mês de óbito: dezembro (10.970) e janeiro (11.904) concentram 22.874 dos 111.555 óbitos (20,5%, contra 16,7% esperados numa distribuição uni

**Censo 2022 — microdados da amostra de acesso público (31/08/2026) e agregados por setor censitário (** — RESPOSTA DIRETA ÀS PERGUNTAS 2 E 4, porque são conclusões, não incertezas:

(2) O que mudou entre o básico 20250417 e o 20260520: SÓ ACRÉSCIMO, nenhuma correção de dado. Comparei o parquet construído em 04/05/2026 a partir do zip 20250417 (data/tracts/2022/2022_tracts_Basico.parquet, 9.140.581 bytes) com o construído hoje a partir do 20260520 (o parquet gerado naquele dia, 9.966.399 bytes): mesmos 468.099 setores, mesmas chaves, 0 setor a mais ou a menos, e as 36 colunas comuns são idênticas célula a célula — 0 divergências em 16,8 milhões de células, mesmas somas, mesmos NAs. A única diferença são duas colunas novas: V0008 "Total de Domicílios Particulares de Uso Ocasional (DPPUO)" (6.

**1960 e o panorama dos logs de atualização do IBGE (varredura completa da árvore /Censos/ do FTP)** — 1) Não abri integralmente os 27 zips de setores 2010 de 15/06/2026 — baixei RR inteiro (4.904.393 bytes, MD5 4660744e2831de14f4127eeac753e0c2) e li por HTTP Range partes de SP_Capital, SP_Exceto_Capital, GO, CE, DF, MG, PE, RS, AC e ES. A conclusão "Cod_setor sanado" está verificada em RR, SP1, SP2, GO e CE; para as 22 UFs restantes é extrapolação pela data e pelo procedimento único declarado no log. 2) Verifiquei FORMATO e NOMES nos arquivos de 15/06/2026, não VALORES. Todos os CSVs foram regerados naquela data, mas o log só fala em Cod_setor; uma comparação de conteúdo entre a distribuição de 2023 e a de 2026 (célula a célula, 310 mil setores × ~2.000 variáveis) ficou fora do escopo e é a 
