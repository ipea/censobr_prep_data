...
(2) O que mudou entre o básico 20250417 e o 20260520: SÓ ACRÉSCIMO, nenhuma correção de dado. Comparei o parquet construído em 04/05/2026 a partir do zip 20250417 (data/tracts/2022/2022_tracts_Basico.parquet, 9.140.581 bytes) com o construído hoje a partir do 20260520 (2022_tracts_basico_v0.7.0.parquet, 9.966.399 bytes): mesmos 468.099 setores, mesmas chaves, 0 setor a mais ou a menos, e as 36 colunas comuns são idênticas célula a célula — 0 divergências em 16,8 milhões de células, mesmas somas, mesmos NAs. A única diferença são duas colunas novas: V0008 "Total de Domicílios Particulares de Uso Ocasional (DPPUO)" (6.
